...
# write tree info
write.table(cbind(x_chrom, x_start, x_end), file="greenbul_100kbp_tree_info.txt", sep="\t", quote=F, row.names=F, col.names=F)
...
write(tree_list, file="greenbul_100kbp.trees", ncolumns=1)
