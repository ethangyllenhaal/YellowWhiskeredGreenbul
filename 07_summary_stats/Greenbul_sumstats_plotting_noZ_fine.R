...
dxy <- read.table("window_noZ100k_fine_dxy.txt", header=T)
fst <- read.table("window_noZ100k_fine_fst.txt", header=T)
pi <- read.table("window_noZ100k_fine_pi.txt", header=T)
pi$calculated_stat[is.na(pi$calculated_stat)] <- 0
tajima <- read.table("window_noZ100k_fine_tajima.txt", header=T)
# combine all
...
stat_order <- rbind(c("East", "West", "Dxy"),
                    ...
                    c("East", "Northeast", "Dxy"),
                    c("East", "Rwenzori", "Dxy"),
                    c("Central", "West", "Dxy"),
                    c("Central", "C_discordant", "Dxy"),
                    c("Central", "Northeast", "Dxy"),
                    c("Central", "Rwenzori", "Dxy"),
                    c("C_discordant", "West", "Dxy"),
                    c("C_discordant", "Northeast", "Dxy"),
                    c("C_discordant", "Rwenzori", "Dxy"),
                    c("West", "Northeast", "Dxy"),
                    c("West", "Rwenzori", "Dxy"),
                    c("Northeast", "Rwenzori", "Dxy"),
                    c("East", "West", "Fst"),
                    c("East", "Central", "Fst"),
