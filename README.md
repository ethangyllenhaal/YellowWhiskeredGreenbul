...
This section by Joe Manthey. Scripts can be found here: https://github.com/jdmanthey/greenbul_phylogeography. A short summary of relevant scripts is below:

***05_filter_redo.sh - Slurm array job to filter each chromosome to exclude all missing data with 5k thinning.

***06_pca_admixture_redo.sh - Slurm array job for first making a combined VCF then running admixture and a plink PCA.

### 05_phylogenetics

This section by Swapnil Boyane
